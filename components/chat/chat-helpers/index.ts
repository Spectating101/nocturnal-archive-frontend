...
export const fetchNocturnalCache = async (
  topic: string,
  questions: string[] = []
) => {
  const qs = new URLSearchParams()
  qs.set("topic", topic)
  if (questions.length) qs.set("questions", JSON.stringify(questions))
  const res = await fetch(`/api/nocturnal/cache?${qs.toString()}`)
...
export const createTempMessages = (
  ...
  let tempUserChatMessage: ChatMessage = {
    ...
    fileItems: [] // Array of file item IDs (strings)
  }
